...
FFMPEG_OPENIPC_CONF_OPTS = \
	...
	--disable-nvdec --disable-nvenc --disable-vaapi --disable-vdpau --disable-videotoolbox \
	--enable-avdevice --disable-swscale --disable-postproc --disable-doc --disable-runtime-cpudetect \
	...
	--disable-muxers --enable-muxer=flv,rtsp,rtpenc_chain,rtp,sdp \
	--disable-demuxers --enable-demuxer=h264,rtsp,rtp,sdp \
